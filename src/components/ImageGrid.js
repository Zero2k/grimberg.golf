    ...
    <div tw="max-w-7xl mx-auto px-20 mt-20 mb-40">
      ...
      <div tw="grid grid-flow-col grid-rows-2 grid-cols-3 gap-4">
        <div tw="transform scale-110 -rotate-6 -translate-x-5">
          <div tw="w-full h-40 lg:h-60 xl:h-80 bg-white rounded-xl shadow-lg hover:shadow-xl flex items-center justify-center">
            <img
              tw="object-cover object-center w-full h-40 lg:h-60 xl:h-80 rounded-xl"
        ...
        <div tw="col-start-3 transform scale-90 rotate-6 translate-x-7 translate-y-14">
          <div tw="w-full h-40 lg:h-60 xl:h-80 bg-white rounded-xl shadow-lg hover:shadow-xl flex items-center justify-center">
            <img
              tw="object-cover object-center w-full h-40 lg:h-60 xl:h-80 rounded-xl"
        ...
        <div tw="transform scale-90 -translate-x-7 translate-y-11">
          <div tw="w-full h-40 lg:h-60 xl:h-80 bg-white rounded-xl shadow-lg hover:shadow-xl flex items-center justify-center">
            <img
              tw="object-cover object-center w-full h-40 lg:h-60 xl:h-80 rounded-xl"
        ...
        <div tw="transform translate-y-24">
          <div tw="w-full h-40 lg:h-60 xl:h-80 bg-white rounded-xl shadow-lg hover:shadow-xl flex items-center justify-center">
            <img
              tw="object-cover object-bottom w-full h-40 lg:h-60 xl:h-80 rounded-xl"
        ...
        <div tw="row-start-1 col-start-2 col-span-2 transform translate-x-12">
          <div tw="w-full h-40 lg:h-60 xl:h-80 bg-white rounded-xl shadow-lg hover:shadow-xl flex items-center justify-center">
            <img
              tw="object-cover object-bottom w-full h-40 lg:h-60 xl:h-80 rounded-xl"
