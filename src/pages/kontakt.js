        ...
        <Section>
          <div tw="max-w-5xl mx-auto">
            <div tw="overflow-hidden">
              <div tw="grid grid-cols-1 md:grid-cols-2 bg-gray-50 space-x-0 lg:space-x-2">
                ...
                <form tw="p-6 lg:p-10 flex flex-col justify-center">
                  ...
                  <button
                    type="submit"
                    tw="md:w-32 bg-indigo-700 text-white font-bold py-3 px-6 rounded-full mt-4 hover:bg-indigo-800"
                  >
                    Skicka
                  </button>
                </form>
